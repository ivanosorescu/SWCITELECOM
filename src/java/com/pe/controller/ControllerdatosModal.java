...
public class ControllerdatosModal extends HttpServlet {
    ...
    String Cantidadoc = "CantidadRequerimiento.jsp";
    String Cantidadguiaremitente = "Cantidadguiaremitente.jsp";
    String Cantidadguiaremisioncliente = "Cantidadguiaremisioncliente.jsp";
    String cantrefguia = "RefCantidadguiaremitente.jsp";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equalsIgnoreCase("Cantidadguiaremitente")) {
            request.setAttribute("guiaremi", request.getParameter("id"));
            acceso = Cantidadguiaremitente;
        }
        ...
        if (action.equalsIgnoreCase("cantrefguia")) {
            request.setAttribute("refguia", request.getParameter("id"));
            acceso = cantrefguia;
        }
