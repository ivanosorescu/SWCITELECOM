...
public class DashboardDAO {
    ...
    public String rqpendiente() {
        String sql = "{call sp_generar_contarRQP()}";
        try {
    ...
    public String contarrequerimiento() {
        String sql = "{call sp_generar_contarrequerimiento()}";
        try {
            con = cn.getConnection();
            call = con.prepareCall(sql);
            rs = call.executeQuery();
    ...
    public String Contarempleado() {
        String sql = "{call sp_generar_contarempleado()}";
        try {
            con = cn.getConnection();
            call = con.prepareCall(sql);
            rs = call.executeQuery();
