                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <br>
                                    <form id="newempleado" action="EmpleadoController" method="Post" name="frm_nuevo">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                                <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-11 col-md-8 col-sm-12 col-xs-12">
                                                            <input type="text" name="Txtdni" onkeypress="return soloNumeros(event)" maxlength="11" id="input_ruc" class="border-focus-darkblue form-control">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-4 col-md-8 col-sm-12 col-xs-12">
                                                            <input type="text" name="Txtsueldo" id="Txtsueldo" class="border-focus-darkblue form-control">
                                                            <span class="help-block"></span>
                                                        </div>
                                                    </div>
                                                </fieldset>
...
<!--                                                    <label>RUC:</label>
                                        ...
                                        <div class="modal-footer"> 
                                            <center>
                                                ...
                                                <button onclick="return valnewEmpleado()" type="submit" name="accion" class="btn btn-app bg-cyan" ><i class="fas fa-check-square"></i> GRABAR</button>
                                            </center>
                                        </div>
                                    </form>
                                </div>
