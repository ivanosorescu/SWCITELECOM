                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-default">
                                <div class="card-header" style="background-color:#525173;" >
                                    <h3 class="card-title" style="color: white;">REQUERIMIENTOS</h3>
                                    ...
                                    <br>
                                    <h6 style="color: white;">Genaerar salida y Eliminar</h6>
                                </div>
                                <div class="card-body"> 
                                    <div class="row">
                                    ...
                                    <div class="full-width panel-content" id="div1">
                                        <table id="B" class="table table-striped table-bordered second" style="width:100%">
                                            ...
                                            <td>
                                                <%
                                                    if (Estado.equalsIgnoreCase("Pendiente")) {%>
                                                <a href="RefNotadeSalidaController?accion=refNotai&id=<%=vent.getIdmovimiento()%>" class="btn-sm btn-primary" class="anular">Nota de Salida</a>
                                                <%   } else { %>
