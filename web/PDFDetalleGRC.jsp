                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-7 DivLogos">
                                                        ...
                                                        <h6 class="FormatLetraDirEmisor">Urb. La Estrella de Santa Clara Mz.C Lt. 1 <br>ATE - LIMA - PERU</h6>
                                                    </div>
                                                ...
                                                <div class="row" style="margin-top:2px !important">
                                                    <div class="col-xs-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8 col-sm-8 col-xs-8 PositionProveedorInvoice2">
                                                                <h5 class="FormatAlingProveedorInvoiceDetall" style="margin-top: 10px;">Urb. La Estrella de Santa Clara Mz.C Lt. 1</h5>
