                            ...
                            <div class="info-box">
                                <span class="info-box-icon bg-info elevation-1"><i class="fas fa-cog"></i></span>
                                    <%     DashboardDAO comm = new DashboardDAO();
                                        String numcli = comm.contarrequerimiento();
                                    %>
                                <div class="info-box-content">
                                    <span class="info-box-text">Total de requerimientos</span>
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="info-box mb-3">
                                <span class="info-box-icon bg-danger elevation-1"><i class="fas fa-shopping-cart"></i></span>
                                    ...
                                    %>
                                <div class="info-box-content">
                                    <span class="info-box-text">Total de compra</span>
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="info-box mb-3">
                                <span class="info-box-icon bg-success elevation-1"><i class="far fa-credit-card"></i></span>
                                    ...
                                    %>
                                <div class="info-box-content">
                                    <span class="info-box-text">Valor total de Compra</span>
                                ...
                                <div class="info-box mb-3 bg-success">
                                    <span class="info-box-icon"><i class="fas fa-tag"></i></span>
                                        <% DashboardDAO cxm = new DashboardDAO();
                                            String numRQ = cxm.rqpendiente();
                                        %>
                                    <div class="info-box-content">
                                        <span class="info-box-text">REQ Pendientes</span>
