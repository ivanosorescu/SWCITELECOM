                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-4 DivInvoceCuadroCabecera">
                                                        <div class="panel1 panel-default DivContentInvoceCuadroCabecera">
                                                            ...
                                                            <h4 class="FormatInvoiceCuadroCabecera">REQUERIMIENTO</h4>
                                                        ...
                                                        <div style="">
                                                            <div class="row">
                                                                <div class="col-md-5 col-sm-4 col-xs-3">
                                                                    ...
                                                                    <h6 class="FormatAlingProveedorInvoice" style="margin-top: 10px;">AREA</h6>
                                                                    <h6 class="FormatAlingProveedorInvoice" style=" margin-top: 10px;">PROYECTO</h6>
                                                                </div>
                                                                <div class="col-md-7 col-sm-2 col-xs-3">
                                                                    <h5 class="FormatAlingProveedorInvoiceDetall" style="margin-top: 10px;">: Instalaciones de Telecom System </h5>
                                                                    <h5 class="FormatAlingProveedorInvoiceDetall" style="margin-top: 10px;">: <%=p.getFechaentrega()%> </h5>
                                                                    <h5 class="FormatAlingProveedorInvoiceDetall" style="margin-top: 10px;">: REDES</h5>
