                                        ...
                                        <table width="100% " class="table_fill table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="width:4px;">
                                                        <input class="form-control form-control-sm" style="width : 110px; text-align:right;" value="<%=String.format("%.2f", ni.getCosto())%>" id="txtPro_precio<%=fila%>" name="txtPro_precio" type="number" min="1"  onchange="actualizarpreciocomprafc(<%= fila%>)" required="">
                                                    </td>
