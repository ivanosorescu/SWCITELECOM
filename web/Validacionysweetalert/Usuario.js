...
$(function () {
    $("#editusu").on("submit", function (e) {
        e.preventDefault();
        var data = $('#editusu').serialize();
        $.post("UsuarioController?accion=Actualizar", data, function (res, est, jqXHR) {
            if (res === "ok") {
...
$(function () {
    $("#newusu").on("submit", function (e) {
        e.preventDefault();
        var data = $('#newusu').serialize();
        $.post("UsuarioController?accion=add", data, function (res, est, jqXHR) {
            if (res === "ok") {
                swal("Se ha guardado la informacion", {
                    icon: "success"
                })
                ...
                debugger;
                swal("Trabajador ya tiene usuario", {
                    icon: "warning"
                });
                return false;
            } else {
