                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        swal("Se elimino el item", {
                            ...
                            if (willDelete) {
                                parent.location.href = "RefNotadeSalidaController?accion=procesarCarritorefni";
                            }
...
function actualizarcantidad(idproducto) {
    ...
    window.location.href = "RefNotadeSalidaController?accion=refNotaIActualizarcantidad&cantniref=" + cantidad + "&idproductorefni=" + idproducto;
}
//funcion guardar
$(function () {
    $("#newventa").on("submit", function (e) {
        ...
        $.post("RefNotadeSalidaController?accion=RegistrarrefNotadesalida", data, function (res, est, jqXHR) {
            if (res === "oki") {
            ...
            dangerMode: true
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        $.post("RefNotadeSalidaController", data, function (res, est, jqXHR) {
                            //console.log('res ',res);
                            ...
                            if (jqXHR.status === 200) {
                                ...
                                swal("Se anulo el documento correctamente!", {
                                    ...
                                    if (willDelete) {
                                        parent.location.href = "ListarNotasalida.jsp.jsp";
                                    }
                                });
                                ;
                            }
