...
<html lang="en">
    ...
    <%  Auxiliar objProvedorGRM = null;
        if (request.getSession().getAttribute("proveedorGRM") != null) {
            objProvedorGRM = (Auxiliar) request.getSession().getAttribute("proveedorGRM");
        } else {
            objProvedorGRM = new Auxiliar();
            objProvedorGRM.setIdauxiliar(0);
            objProvedorGRM.setCorreo("");
            objProvedorGRM.setNumerodocumento("0");
            objProvedorGRM.setNombre("");
            objProvedorGRM.setDireccion("");
        }
    %>
    <body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <form id="newventa" method="post" name="accion" action="GuiaRemitenteController">
                    <input type="hidden" name="accion" value="Registrarguiaremitente" />
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-outline card-info">
                                <div class="card-header" style="background-color:#525173;">
                                    <h3 class="card-title" style=" color: #fff;">
                                        EMITIR GUÍA REMITENTE
                                    </h3>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="d-flex">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="txtTipodoc" id="tipo_comprobante" required="" class="form-control form-control-sm">
                                                        <option value="Guia Remitente">GUÍA DE REMISIÓN</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="d-flex">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group input-group-sm">
                                                        <input type="hidden" name="txtIdcli" value="<%=objProvedorGRM.getIdauxiliar() == 0 ? "" : objProvedorGRM.getIdauxiliar()%>" class="form-control">
                                                        <input type="text" name="txtNombre" value=" <%=objProvedorGRM.getNombre()%>" class="form-control">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control form-control-sm" name="txtI" value="<%=objProvedorGRM.getNumerodocumento()%>">
                                                </div>
                                            </div>
                                            <div class="d-flex">
                                                <label class="col-sm-3 col-form-label" style="text-align:right">Correo Receptor:</label>
                                                <div class="col-sm-9">
                                                    <input class="form-control form-control-sm" name="txtcorreo" value="<%=objProvedorGRM.getCorreo()%>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control form-control-sm" name="txtTienda" value="TELECOM SYSTEM ING. ASOC. SAC" required="">
                                                </div>
                                            </div>
                                            <div class="d-flex">
                                                <label class="col-sm-3 col-form-label" style="text-align:right">Tienda:</label>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control form-control-sm" type="text" name="txtdirecc" value="<%=objProvedorGRM.getDireccion()%>">
                                                </div>
                                            </div>
                                            <!-- /.form-group -->
                                            <div class="d-flex">
                                                <label class="col-sm-4 col-form-label" style="text-align:right">Punto de Llegada:</label>
                                                <div class="col-sm-8">
                                ...
                                <div class="card-body p-0">
                                    <div class="table-wrapper">
                                        <table width="100% " class="table_fill table-striped">
                                            ...
                                            <%
                                                ArrayList<DetalleMovimiento> listar = (ArrayList<DetalleMovimiento>) session.getAttribute("cargrm");
                                                int fila = 0;
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td  style="width:5px;">
                                                        <input  class="form-control form-control-sm" style="width :110px; text-align:center;" type="number" value="<%=String.format("%.2f", ni.getCantidad())%>" placeholder="1.00" step="0.01" min="0.01" id="txtPro_cantidad<%=fila%>" name="txtPro_cantidad"  onchange="actualizarcantidad(<%= fila%>)" required>
                                                    </td>
                                                    <td style="width:4px;">
                                        ...
                                        <div class="col-md-10">
                                            <div class="card-body">
                                                <div class="form-group row">
                                                    <a href="ProductosActivosgrm.jsp" class="btn btn-primary float-right"  role="button" style="height: 30px;display: inline-block;margin-bottom: 0;font-weight: bold;text-align: center;vertical-align: middle;letter-spacing: 1px;text-transform: uppercase;-ms-touch-action: manipulation;touch-action: manipulation;cursor: pointer;transition: all 0.2s;background-image: none;border: 2px solid transparent;white-space: nowrap;padding: 2px 18px;font-size: 12px;line-height: 1.78571;border-radius: 20px;-webkit-user-select: none;-ms-user-select: none;user-select: none;padding-top: 3px;">AGREGAR ITEM</a>
                                                    <a class="btn btn-secondary" href="GuiaRemitenteController?accion=Limpiargrm">Limpiar</a> 
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group row"> 
                                                    ...
                                                    <a class="btn btn-primary float-right" href="ListarGuiaremitente.jsp" role="button">Salir</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <tbody >
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:8%">
                                                    ...
                                                    <a  href="ProveedorController?accion=buscarPorIdGRM&idProveedorGRM=<%=p.getIdauxiliar()%>" ><i class="glyphicon glyphicon-plus-sign" style="color: #09bb04" data-toggle="tooltip" title="agregar"></i></a>
                                                </td>
                                                <td><%=p.getCodigo()%></td>
                                                <td><%=p.getNombre()%></td>
        ...
        <script src="Validacionysweetalert/Guiaremitente.js" type="text/javascript"></script>
