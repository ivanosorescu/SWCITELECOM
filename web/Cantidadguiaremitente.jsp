    ...
    <body>
        ...
        <div >
            <%
                ...
                int id = Integer.parseInt((String) request.getAttribute("guiaremi"));
            ...
            <div class="modal-content">
                ...
                <form method="post" action="GuiaRemitenteController" accion="AnadirCarritogrm"> 
                    ...
                    <div class="modal-footer">
                        <a href="ProductosActivosgrm.jsp" class="btn btn-default" >Cancelar</a> 
                        <input type="submit" value="Añadir" class="btn btn-success" name="btnAnadir">
                        <input type="hidden" name="accion" value="AnadirCarritogrm"/>
                    </div>
                </form>
            </div>
        </div>
