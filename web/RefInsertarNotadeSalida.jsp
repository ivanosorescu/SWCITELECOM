    ...
    <body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <form id="newventa" method="post" name="accion" action="RefNotadeSalidaController">
                    <input type="hidden" name="accion" value="RegistrarrefNotadesalida" />
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-outline card-info">
                                <div class="card-header">
                                    <h3 class="card-title" style=" color: #fff;">
                                        EMITIR NOTA DE SALIDA DESDE UN REQUERIMIENTO
                                    </h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control form-control-sm" name="txtTienda" value="TELECOM SYSTEM ING. ASOC. SAC">
                                                </div>
                                            </div>
                                            <div class="d-flex">
            ...
            <script src="Validacionysweetalert/RefNotadeSalida.js" type="text/javascript"></script>
