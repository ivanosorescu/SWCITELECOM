...
<html>
    <head>
        ...
        <title>TELECOM SYSTEM ING. ASOC. SAC</title>
    </head>
    <body>
        <!-- add Modal HTML -->
        <div >
            <%
                ...
                int id = Integer.parseInt((String) request.getAttribute("refguia"));
            ...
            <div class="modal-content">
                ...
                <form method="post" action="RefGuiadeRemisionController" accion="AnadirCarritorefgr"> 
                    ...
                    <div class="modal-footer">
                        <a href="RefProductosActivosguia.jsp" class="btn btn-default" >Cancelar</a> 
                        <input type="submit" value="Añadir" class="btn btn-success" name="btnAnadir">
                        <input type="hidden" name="accion" value="AnadirCarritorefgr"/>
                    </div>
                </form>
            </div>
        </div>
