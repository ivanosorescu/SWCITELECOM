...
<html>
    <head>
        ...
        <title>Nota de Ingreso Telecom System Ing. Asoc. SAC"</title>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-default">
                                <div class="card-header" style="background-color:#525173;">
                                    <h3 class="card-title" style="color: white;">GUÍA DE REMISIÓN-COMPRA</h3>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <select class="form-control select2" name="cbDocu" id="cbDoc" required="" disabled="true"
                                                ...
                                                <% MovimientoDAO vddao = new MovimientoDAO();
                                                    List<Movimiento> vdlist = vddao.ListadoGuiaremisionproveedor();
                                        ...
                                        <table id="B" class="table table-striped table-bordered second" style="width:100%">
                                            ...
                                            <tbody>
                                                <%  MovimientoDAO vdao = new MovimientoDAO();
                                                    List<Movimiento> vlist = vdao.ListadoGuiaremisionproveedor();
                                            ...
                                            <td>
                                                ...
                                                <a href="RefNotadeIngresoController?accion=refNotai&id=<%=vent.getIdmovimiento()%>" class="btn-sm btn-warning" class="anular">NI</a>
                ...
                <div class="modal-content">
                    <form id="editarestado"  method="post" action="NotadeIngresoController" name="frm_edit"> 
                        ...
                        <div class="modal-footer">
                            <a href="ListarGuiaremitente.jsp" class="btn btn-default" >Cancelar</a> 
